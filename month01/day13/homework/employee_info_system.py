...
class EmployeeController:
    ...
    def ascending_order(self):
        for r in range(len(self.__all_employee) - 1):
            for c in range(r + 1, len(self.__all_employee)):
                if self.__all_employee[r].money > self.__all_employee[c].money:
                    self.__all_employee[r], self.__all_employee[c] = self.__all_employee[c], self.__all_employee[r]
